...
@section('title', 'Xem thông tin danh mục loại sản phẩm')
            ...
            <div class="card card-outline">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <h4 class="mb-0">Xem thông danh mục loại sản phẩm - Mã: <strong class="text-danger">{{$id}}</strong></h4>
                    </div>
                </div> 
                <!--end::Header-->
                <!--begin::Body-->
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" class="form-control" id="ICON" name="fileICON" disabled>
                                    @error('ICON')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="IDPARENT" id="IDPARENT"  class="form-select" disabled
                                              value={{$data->IDPARENT}}>
                        ...
                        <div class="col-md-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="META_TITLE"  disabled
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="META_KEYWORD"  disabled
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="META_DESCRIPTION" id="META_DESCRIPTION" disabled rows="3" class="form-control">{{$data->META_DESCRIPTION}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-footer">
                    {{-- <button type="submit" class="btn btn-primary" disabled>Ghi lại</button> --}}
                    <a href="{{route('category.index')}}" class="btn btn-secondary" type="button">Quay lại</a>
                </div>
                <!--end::Footer-->
            </div>
            <!--end::card-->
