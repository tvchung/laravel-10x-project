                    ...
                    <tr class="align-middle">
                        ...
                        <td class="action">
                            <div class="d-flex justify-content-between align-items-center mx-3">   
                                <a href="{{route('category.detail',[$item->id])}}" title="Xem chi tiết">
                                    <i class="fa-regular fa-eye"></i>
                                </a>
                                <a href="{{route('category.edit',[$item->id])}}" title="Sửa thông tin">
                                    <i class="fa-regular fa-pen-to-square"></i>
                                </a>
                                <a href="{{route('category.detail',[$item->id])}}" title="Xóa danh mục">
